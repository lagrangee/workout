...
description: 以训练计划为依据，从今日执行一直连接到历史趋势的个人训练记录系统
colors:
  accent: "#d65d3f"
  accent-dark: "#a8432c"
  green: "#477a5d"
...
typography:
  display:
    fontFamily: "Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'PingFang SC', sans-serif"
...
- **Style:** the default product navigation is a fixed bottom bar with four equal columns, #fffdf8 translucent surface, top divider and 14px minimum tap height. The active item uses deep terracotta and weight 800; inactive items use muted.
