...
const files = ["wrangler.toml", "migrations/0001_initial.sql", "migrations/0002_state_revision.sql", "migrations/0003_query_indexes.sql", "seed/workout-tracker-weekly-seed.json", "docs/deployment/cloudflare-production-checklist.md", "docs/deployment/github-actions.md", "docs/recovery/d1-time-travel-and-export-rehearsal.md", "docs/release/seed-verification.md", "docs/release/production-acceptance.md", ".github/workflows/ci.yml", ".github/workflows/deploy.yml"];
