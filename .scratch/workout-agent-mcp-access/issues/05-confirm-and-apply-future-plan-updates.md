...
- [ ] Repeating the same idempotent request within the 24-hour idempotency retention window returns the original successful result without creating another Plan Revision; reusing the key with a different body is rejected.
